...
export const register  = async (req,res)=>{
    ...
    try{
        ...
        const mailOptions = {
            ...
            text:`Hello ${user.name},\n\nWelcome to our platform! your account has been successfully created with email id: ${user.email}`
        };
...
// Send OTP for verification to user's email
...
export const resetPassword = async (req,res) =>{
       ...
       const { email, otp, newPassword } = req.body; // Code expects newPassword
